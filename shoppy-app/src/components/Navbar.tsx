    ...
    return (<BsNavBar sticky="top" className="p-3 shadow rounded bg-light">
        <Container className='me-auto'>
            ...
            <div className='d-flex'>
                ...
                <Button style={{ width: "50px", height: "50px", textAlign: 'center', verticalAlign: 'center', position: 'relative' }}
                    ...
                    style={{color: "white", width: "20px", height: '20px', position:'absolute', bottom:'0', right:'0',
